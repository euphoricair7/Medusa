...
class AlertOut(BaseModel):
    ...
    namespace:      Optional[str] = Field(default=None, description="The namespace where the alert was triggered")
    pod_name:       Optional[str] = Field(default=None, description="The name of the pod where the alert was triggered")
